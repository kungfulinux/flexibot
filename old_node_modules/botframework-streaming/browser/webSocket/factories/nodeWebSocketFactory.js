...
var nodeWebSocketFactoryBase_1 = require("./nodeWebSocketFactoryBase");
var NodeWebSocketFactory = /** @class */ (function (_super) {
    __extends(NodeWebSocketFactory, _super);
     ...
     */
    NodeWebSocketFactory.prototype.createWebSocket = function (req, socket, head) {
        return __awaiter(this, void 0, void 0, function () {
            var s;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        s = new nodeWebSocket_1.NodeWebSocket();
                        return [4 /*yield*/, s.create(req, socket, head)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, s];
                }
    ...
    return NodeWebSocketFactory;
}(nodeWebSocketFactoryBase_1.NodeWebSocketFactoryBase));
