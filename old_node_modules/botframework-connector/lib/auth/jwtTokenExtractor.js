            ...
            try {
                ...
                if (this.tokenValidationParameters.algorithms) {
                    if (this.tokenValidationParameters.algorithms.indexOf(decodedToken.header.alg) === -1) {
                        throw new authenticationError_1.AuthenticationError(`"Token signing algorithm '${decodedToken.header.alg}' not in allowed list`, botframework_schema_1.StatusCodes.UNAUTHORIZED);
                    }
                }
